        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <button onclick="document.getElementById('updateForm<?php echo $row['id']; ?>').style.display='bloc>
                    </td>
                </tr>
                ...
                <div id="updateForm<?php echo $row['id']; ?>" style="display:none;">
                    <form action="" method="post">
                        ...
                        <button type="button" onclick="document.getElementById('updateForm<?php echo $row['id']; ?>').style>
                    </form>
                </div>
