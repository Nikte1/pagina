...
// Eliminar proveedor y sus registros relacionados en inventario
if (isset($_GET['delete_id'])) {
    $id = $_GET['delete_id'];
    
    // Eliminar registros relacionados en la tabla 'inventario'
    $stmt = $conn->prepare("DELETE FROM inventario WHERE proveedor_id=?");
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="?delete_id=<?php echo $row['id']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este proveedor?')">Eliminar</a>
                    </td>
                </tr>
